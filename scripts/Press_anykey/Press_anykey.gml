function keyboard_check_anykey(player)
{
	if player = 1
	{
		...
		|| keyboard_check(global.player1_key_grab) || keyboard_check(global.player1_key_guard)
	...
	if player = 2
	{
		...
		|| keyboard_check(global.player2_key_grab) || keyboard_check(global.player2_key_guard)
...
function keyboard_check_pressed_anykey(player)
{
	if player = 1
	{
		...
		|| keyboard_check_pressed(global.player1_key_grab) || keyboard_check_pressed(global.player1_key_guard)
	...
	if player = 2
	{
		...
		|| keyboard_check_pressed(global.player2_key_grab) || keyboard_check_pressed(global.player2_key_guard)
...
function gamepad_check_anykey(player)
{
	if player = 1
	{
		...
		|| gamepad_button_check(global.p1_controller, global.p1_gp_grab)
	...
	if player = 2
	{
		...
		|| gamepad_button_check(global.p2_controller, global.p2_gp_grab)
...
function gamepad_check_pressed_anykey(player)
{
	if player = 1
	{
		...
		|| gamepad_button_check_pressed(global.p1_controller, global.p1_gp_grab)
	...
	if player = 2
	{
		...
		|| gamepad_button_check_pressed(global.p2_controller, global.p2_gp_grab)
